  ...
  restaurants: [
    {
      ...
      itemName: "Rosgolla",
      description:
        "Iconic Bengali sweet made of soft, spongy cheese balls soaked in syrup",
      quantityAvailable: 5,
      quantityUnit: "plate",
      price: "100",
    ...
    },
    {
      ...
      description:
        "Fried flatbreads (luchi) served with spiced potato curry (alur dom)",
      quantityAvailable: 1,
      quantityUnit: "plates",
      price: "120\t",
...
export const clientRestaurantDetail = {
  message: "Retrieved 7 restaurants.",
  restaurants: [
    {
      restaurantId: 10,
      name: "Pizza Palace",
    ...
    },
    {
      restaurantId: 13,
      name: "Burger Bonanza",
      description: "Fast food with premium quality ingredients.",
...
//Customer signin
export const customerSigninResponse = {
  city: "New York",
  customerId: "3",
};

//Merchant signup
export const merchantSignupResponse = {
  merchantId: "1",
};

// customer credit
export const customerCreditResponse = {
  "credit": 10000
}

//customer RestaurantList 
export const customerRestaurantListResponse ={
  "message": "Retrieved 7 restaurants.",
  "restaurants": [
      {
          "restaurantId": 10,
...
export const customerRestaurantItemResponse ={
  "message": "Retrieved 5 items.",
  "restaurants": [
      {
          "id": 16,
